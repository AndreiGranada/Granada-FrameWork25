...
exports.authLimiter = (0, express_rate_limit_1.default)({
    ...
    handler: (_req, res, _next, options) => {
        ...
        return errors_1.errorHelpers.rateLimit(res, 'Muitas requisições de autenticação. Tente novamente mais tarde.', retryAfterSeconds);
    }
});
...
exports.sosLimiter = (0, express_rate_limit_1.default)({
    ...
    handler: (_req, res, _next, options) => {
        const retryAfterSeconds = Math.ceil(options.windowMs / 1000);
        res.setHeader('Retry-After', String(retryAfterSeconds));
        return errors_1.errorHelpers.rateLimit(res, 'Muitas requisições S.O.S. Tente novamente mais tarde.', retryAfterSeconds);
    }
});
